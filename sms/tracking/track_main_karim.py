...
from sms.tracking.toad_object_karim import ToadObject
import time
...
def main(
    ...
    execute_grasp_handle = server.add_gui_button("Execute Grasp for Query", disabled=True) # Button for querying the object once the user has inputted the query
