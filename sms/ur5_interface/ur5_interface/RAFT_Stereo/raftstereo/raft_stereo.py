...
@dataclass
class RAFTConfig:
    restore_ckpt: str = "/home/lifelong/ur5_legs/RAFT-Stereo/models/raftstereo-middlebury.pth"
...
def raft_inference(left: torch.Tensor, right:torch.Tensor, model, iters = 32):
    ...
    left, right = padder.pad(left[None,...].to(torch.float32), right[None,...].to(torch.float32))
